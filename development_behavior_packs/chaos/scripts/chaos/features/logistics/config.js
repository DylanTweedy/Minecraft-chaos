// scripts/chaos/features/logistics/config.js
...
const DEFAULTS = {
  ...
  maxExportsPerTick: 6,
  maxResolvesPerTick: 6,
  maxArrivalsPerTick: 24,
  maxDeparturesPerTick: 24,
  maxIoExtractsPerTick: 8,
  maxIoInsertsPerTick: 8,
  maxMovementsPerTick: 128,
  maxFluxPerTick: 24,
  maxInflightOrbs: 300,
