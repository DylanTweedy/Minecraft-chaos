// scripts/chaos/features/transposer/pairs.js
...
export function markTransposerDirty() {
  dirty = true;
}
...
export function loadTransposerPairsFromWorldSafe() {
  pairs.clear();
...
export function saveTransposerPairsToWorldSafe() {
  if (!persistenceEnabled) return;
...
export function saveTransposerPairsIfDirty() {
  if (!dirty) return;
  saveTransposerPairsToWorldSafe();
}
